...
impl Matrix {
    ...
    pub fn multiply(&mut self, other: &Matrix) -> Matrix {
        if self.cols != other.rows {
            panic!("Attempted to multiply by matrix of incomplete dimensions")
        }
    ...
    pub fn add(&mut self, other: &Matrix) -> Matrix {
        if self.cols != other.cols || self.rows != other.rows {
            panic!("Attempted to add matrix of incomplete dimensions")
        }
    ...
    pub fn dot_multiply(&mut self, other: &Matrix) -> Matrix {
        if self.cols != other.cols || self.rows != other.rows {
            panic!("Attempted to dot multiply by matrix of incomplete dimensions")
        }
    ...
    pub fn subtract(&mut self, other: &Matrix) -> Matrix {
        if self.cols != other.cols || self.rows != other.rows {
            panic!("Attempted to subtract matrix of incomplete dimensions")
        }
